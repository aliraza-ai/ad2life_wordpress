      ...
      <div  class="col-md-3">
        <div class="loc-button">
          <div class="btn-white-shadows">
              <button class="btn btn-primary btn white-back-btn" type="btn"><i class="fas fa-angle-left"></i> BACK</button>
          </div>
           <button class="btn btn-success stat-watch green-back-btn" type="btn">NEXT <i class="fas fa-angle-right"></i></button>
        </div>
        <div class="item-list">         
              <ul>
        ...
        <div class="m-info">
          <div class="loc-button">
            <div class="btn-white-shadows">
             ...
             <button class="btn btn-success green-back-btn stat-watch" type="btn">NEXT <i class="fas fa-angle-right"></i></button>
          </div>
          <h3  class="underline-green">Live Mobile View Add</h3>
          <img src="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/img/mobile1.png" alt="" class="img-fluid">
        </div>
      </div>
